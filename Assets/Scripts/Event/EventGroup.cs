...
public class EventGroup1 : EventGroup
{
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "xx在公司论坛中发帖称由于CEO不顾员工感受长期航行导致自己晕船严重影响正常生活";
        else if (index == 2)
            content = "xx在公司论坛中跟帖称自己总是在工作中收到异常的信号，电脑上总是出现奇怪的英文字符，尤其是在自己睡着之后最为明显（实际上是上班睡觉压键盘上了）";
        else if (index == 3)
            content = "xx在社交媒体上发布信息宣称自己在公司中受到了暴力虐待和排挤，引起各界广泛关注";
        else if (index == 4)
            content = "xx在办公室中宣称CEO已经被机器替换了大脑，根据CEO的一贯表现，员工已经产生了怀疑";
        else if (index == 5)
            content = "xx带领同事将午饭吃的仙人掌泥涂在了办公室的墙面上，成为一种暗示CEO脱离群众不吃仙人掌的行为艺术";
        else if (index == 6)
            content = "以xx为代表的同事们在走廊中抗议重复无意义的工作将会成为人工智能统治世界的嫁衣";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "zz（xx所在事业部）所有员工主导情绪变为“愤怒”";
        else if (index == 2)
            content = "zz（xx所在事业部）所有员工主导情绪变为“愤怒”";
        else if (index == 3)
            content = "xx获得“虐待传闻”状态，所有关系事件修正-5，持续6个回合";
        else if (index == 4)
            content = "zz（xx所在事业部）获得状态“机械傀儡”×1，每个“机械傀儡”导致信念下降30点，持续6回合";
        else if (index == 5)
            content = "zz（xx所在事业部）获得状态“发奋涂墙”×1，每个“发奋涂墙”导致信念下降30点，持续6回合";
        else if (index == 6)
            content = "zz（xx所在事业部）获得状态“警惕人工智能”×1，每个“警惕人工智能”导致信念下降30点，持续6回合";
...
public class EventGroup2 : EventGroup
{
    ...
    protected override void EffectA(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）获得“拖延工期”状态×1，每个“拖延工期”使效率下降3点，持续6个月
    }
    protected override void EffectB(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）获得“占领公厕”状态×1，每个“占领公厕”使工作状态下降3点，持续6回合
    }
    protected override void EffectC(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）获得“上班捕鱼”状态×1，每个“摸鱼”使工作状态下降3点，持续6回合
    }
    protected override void EffectD(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）获得“信号不良”状态×1，每个“信号不良”使效率下降3点，持续6个月
    }
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "xx故意拖延工期，拒绝交付已经完成的工作，但他的同事们都很乐意把自己的工作稍微推一推";
        else if (index == 2)
            content = "在监控摄像中我们可以看到xx正在带领一批同事长期霸占公司的公共厕所带薪如厕，同时剥夺其他人的使用权";
        else if (index == 3)
            content = "xx上班时间带领同事前往甲板捕鱼以示抗议，如果放任事态发展接下来食堂将全面断鱼";
        else if (index == 4)
            content = "xx表示自己最近的工作状态不佳全都是公司的网络信号不良导致的，没有达到KPI应该是公司的问题";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "zz（xx所在事业部）获得“拖延工期”状态×1，每个“拖延工期”使效率下降3点，持续6个月";
        else if (index == 2)
            content = "zz（xx所在事业部）获得“占领公厕”状态×1，每个“占领公厕”使工作状态下降3点，持续6回合";
        else if (index == 3)
            content = "zz（xx所在事业部）获得“上班捕鱼”状态×1，每个“摸鱼”使工作状态下降3点，持续6回合";
        else if (index == 4)
            content = "zz（xx所在事业部）获得“信号不良”状态×1，每个“信号不良”使效率下降3点，持续6个月";
...
public class EventGroup3 : EventGroup
{
    ...
    protected override void EffectA(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）获得状态“食堂降价”×1，每个“食堂降价”使事业部运行成本增加50
    }
    protected override void EffectB(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）获得状态“要求涨工资”×1，每个“要求涨工资”使事业部运行成本增加50
    }
    protected override void EffectC(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //xx所在部门停工6回合
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "xx带领办公室员工在食堂中集体抗议食堂收费的事情，指出在“虚构天堂有限公司”，人们吃午饭不需要花自己的钱";
        else if (index == 2)
            content = "xx在办公室前对所有员工大肆宣传自己的功绩，如果有同样的作为，在“虚构天堂有限公司”已经工资涨到衣食无忧了";
        else if (index == 3)
            content = "xx跟一些同事一直在办公室里敲桌子，自己不工作的同时还严重影响周围同事工作";
        else if (index == 4)
            content = "xx号召员工夺回属于自己的与“虚构天堂有限公司”一样每个月放30天假的权益";
        else if (index == 5)
            content = "xx威胁称自己将要跳槽去“虚构天堂有限公司”";
        else if (index == 6)
            content = "xx表示除非给他“虚构天堂有限公司”一样的待遇，否则分给他的工作就别想推进了";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "zz（xx所在事业部）获得状态“食堂降价”×1，每个“食堂降价”使事业部运行成本增加50";
        else if (index == 2)
            content = "zz（xx所在事业部）获得状态“要求涨工资”×1，每个“要求涨工资”使事业部运行成本增加50";
        else if (index == 3)
            content = "xx所在部门停工6回合";
        else if (index == 4)
            content = "xx所在部门停工6回合";
...
public class EventGroup4 : EventGroup
{
    ...
    protected override void EffectA(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //失败无效果，成功则zz（xx所在事业部）所有人情绪变为“振奋”
    }
    protected override void EffectB(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //失败无效果，成功则zz（xx所在事业部）中所有人获得“仙人掌大战”状态，所有一般事件修正+5，持续6个回合
    }
    protected override void EffectC(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
    ...
    protected override void EffectD(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //失败无效果，成功则zz（xx所在事业部）获得状态“电音派对”×1，每个“电音派对”使事业部工作状态+3，持续6回合
    }
    protected override void EffectE(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //失败无效果，成功则zz（xx所在事业部）获得状态“读书会”×1，每个“读书会”使事业部效率+3，持续6回合
    }
    protected override void EffectF(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //失败无效果，成功则zz（xx所在事业部）获得“甲板烧烤”状态×1，每个“甲板烧烤”使事业部信念+30，持续6回合
    }
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "xx举办了一场甲板脱口秀，欢笑声盖过了引擎的轰鸣";
        else if (index == 2)
            content = "在xx的组织下公司员工进行了异常仙人掌大战，他们拿着仙人掌击剑，穿好护具之后互相投掷仙人球，看起来就像是小学上体育课的孩子们";
        else if (index == 3)
            content = "明星员工xx在嘉年华上办了一场见面会，意图帮助同事们解决问题，有求必应，有问必答。";
        else if (index == 4)
            content = "“我是本场party的主持人xx，这是我们的DJ！”伴随着尖叫声和开场白，电音派对即将开始";
        else if (index == 5)
            content = "主持人xx在台上宣布规则，台下的人们举起手抢着要坐上中间那把扶手椅，虽然看起来像是死刑";
        else if (index == 6)
            content = "大厨xx正马不停蹄地从同事手中接过烤串，他成了一个无情的烧烤机器";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "失败无效果，成功则zz（xx所在事业部）所有人情绪变为“振奋”";
        else if (index == 2)
            content = "失败无效果，成功则zz（xx所在事业部）中所有人获得“仙人掌大战”状态，所有一般事件修正+5，持续6个回合";
        else if (index == 3)
            content = "失败无效果，成功则全公司所有人获得“明星见面会”状态，每回合额外获得3点经验，持续6回合";
        else if (index == 4)
            content = "失败无效果，成功则zz（xx所在事业部）获得状态“电音派对”×1，每个“电音派对”使事业部工作状态+3，持续6回合";
        else if (index == 5)
            content = "失败无效果，成功则zz（xx所在事业部）获得状态“读书会”×1，每个“读书会”使事业部效率+3，持续6回合";
        else if (index == 6)
            content = "失败无效果，成功则zz（xx所在事业部）获得“甲板烧烤”状态×1，每个“甲板烧烤”使事业部信念+30，持续6回合";
...
public class EventGroup5 : EventGroup
{
    ...
    protected override void EffectA(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //失败无效果，成功则zz（xx所在事业部）获得“冥想”状态×1，每个“冥想”使事业部信念+30，持续6回合
    }
    protected override void EffectB(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //失败无效果，成功则zz（xx所在事业部）所有人情绪变为“振奋”
    ...
    protected override void EffectC(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //失败无效果，成功则zz（xx所在事业部）中所有人获得“夜跑”状态，所有一般事件修正+5，持续6个回合
    }
    protected override void EffectD(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //失败无效果，成功则员工获得随机正面特质
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "xx和同事们正闭目冥想，甚至有些进入忘我的状态，悬浮在天空中";
        else if (index == 2)
            content = "xx在规则中明确宣布本次排球比赛不得使用V字斩";
        else if (index == 3)
            content = "xx带领的夜跑队伍越来越大，吸引了很多一边跟着跑一边问是不是着火了的同事";
        else if (index == 4)
            content = "xx在辩论会上眉飞色舞，裁判已经在考虑是否要在规则中加入参赛者必须佩戴头盔的规定";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "失败无效果，成功则zz（xx所在事业部）获得“冥想”状态×1，每个“冥想”使事业部信念+30，持续6回合";
        else if (index == 2)
            content = "失败无效果，成功则zz（xx所在事业部）所有人情绪变为“振奋”";
        else if (index == 3)
            content = "失败无效果，成功则zz（xx所在事业部）中所有人获得“夜跑”状态，所有一般事件修正+5，持续6个回合";
        else if (index == 4)
...
public class EventGroup6 : EventGroup
{
    ...
    protected override void EffectC(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //失败无效果，成功则zz（xx所在事业部）获得状态“资源共享”×1，每个“资源共享”使事业部效率+3，持续6回合
    }
    protected override void EffectD(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //失败无效果，成功则zz（xx所在事业部）获得“产品创意”状态×1，每个“产品创意”使事业部信念+30，持续6回合
    }
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "“哔哔 哔 哔哔哔哔 哔哔”——收到一封来自xx的邮件，在分析明白究竟说了什么值钱，杀毒软件就已经崩溃了";
        else if (index == 2)
            content = "xx在幻灯片中介绍了其他公司领先的工作流程设计理念，提倡使用新的工作管线";
        else if (index == 3)
            content = "为促进互相理解，xx提议同事们各自将自己珍藏的资源共享给其他同事，今天正在介绍世界毁灭前的经典动画葫芦娃";
        else if (index == 4)
            content = "xx在业余时间举办了创意工坊，号召所有同事";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            ...
            content = "失败无效果，成功则zz（xx所在事业部）获得状态“资源共享”×1，每个“资源共享”使事业部效率+3，持续6回合";
        else if (index == 4)
            content = "失败无效果，成功则zz（xx所在事业部）获得“产品创意”状态×1，每个“产品创意”使事业部信念+30，持续6回合";
...
public class EventGroup7 : EventGroup
{
    ...
    protected override void EffectE(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）获得状态“谁是内鬼”×1，每个“谁是内鬼”导致信念下降30点，持续6回合
    }
    protected override void EffectF(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //xx所在部门停工6回合
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "xx非常担心公司目前在商战中遭受的重创无法挽回";
        else if (index == 2)
            content = "xx对同事讲如果公司不升级办公设施，下一次商战依然会失败";
        else if (index == 3)
            content = "xx汇报了自己所在部门面临上游供给不足的状况";
        else if (index == 4)
            content = "对手公司控制了我公司的GPS联网信息，如果不能解决问题，xx接下来两个月都回不去家了";
        else if (index == 5)
            content = "xx怀疑本次商战的失败是由于事业部中有内鬼导致的";
        else if (index == 6)
            content = "xx收到匿名邮件称商战的对手公司已经掌控了我公司的后台接口，即将切断zz（xx所在事业部）与网络的连接";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            ...
            content = "zz（xx所在事业部）获得状态“谁是内鬼”×1，每个“谁是内鬼”导致信念下降30点，持续6回合";
        else if (index == 6)
            content = "xx所在部门停工6回合";
...
public class EventGroup8 : EventGroup
{
    ...
    protected override void EffectC(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）获得状态“用户流失”×1，每个“用户流失”导致信念下降30点，持续6回合
    }
    protected override void EffectD(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）所有员工主导情绪变为“愤怒”
    }
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "公司中关于经营状态下滑的谣言导致人心惶惶，xx希望CEO给出解释";
        else if (index == 2)
            content = "网络上频繁出现的关于我公司蔑视人情恶意破坏用户体验甚至挤占良心对手公司市场的言论导致xx为代表的员工们人心惶惶";
        else if (index == 3)
            content = "xx对于商战失败所带来的用户流失感到十分焦虑";
        else if (index == 4)
            content = "xx和同事们非常恐慌，因为自己家的亲戚在视频电话中对关于我公司的段子信手拈来";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            ...
            content = "zz（xx所在事业部）获得状态“用户流失”×1，每个“用户流失”导致信念下降30点，持续6回合";
        else if (index == 4)
            content = "zz（xx所在事业部）所有员工主导情绪变为“愤怒”";
...
public class EventGroup9 : EventGroup
{
    ...
    protected override void EffectC(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）获得状态“设备维修”×1，每个“设备维修”使事业部运行成本增加50
    }
    protected override void EffectD(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "xx询问CEO关于公司账户被冻结一事是否有计划";
        else if (index == 2)
            content = "xx正在和同事分析在市场监管的调查报告中看到的关于公司对内和对外公布的营收数据有较大出入的问题";
        else if (index == 3)
            content = "xx坚决要求CEO履行市场监管部门提出的设备维护标准";
        else if (index == 4)
            content = "xx和同事们谴责公司使用盗版软件的问题";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            ...
            content = "zz（xx所在事业部）获得状态“设备维修”×1，每个“设备维修”使事业部运行成本增加50";
        else if (index == 4)
...
public class EventGroup10 : EventGroup
{
    ...
    protected override void EffectA(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）获得状态“人人自危”×1，每个“人人自危”导致信念下降30点，持续6回合
    }
    protected override void EffectB(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "xx对同事表示自己非常担心自己也会丢掉工作";
        else if (index == 2)
            content = "xx在论坛中发帖称已经有同事在向其他公司投简历了，并且贴出了详细的教程";
        else if (index == 3)
            content = "xx对CEO表示已经有猎头找上他了";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "zz（xx所在事业部）获得状态“人人自危”×1，每个“人人自危”导致信念下降30点，持续6回合";
        else if (index == 2)
            content = "公司获得状态“琢磨跳槽”×1，每个“琢磨跳槽”状态降低士气10点，持续6回合";
        else if (index == 3)
            content = "zz（xx所在事业部）所有员工获得6个“辛酸”情绪";
...
public class EventGroup11 : EventGroup
{
    ...
    protected override void EffectB(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）获得状态“”×1，每个“怀疑”导致信念下降30点，持续6回合
    }
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "xx在公司论坛中发帖称公司如果不公开财务信息则说明公司可能会持续裁员";
        else if (index == 2)
            content = "xx因为员工的离职陷入了悲痛之中，昨天晚上梦见了公司账户已经见底";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            ...
            content = "zz（xx所在事业部）获得状态“”×1，每个“怀疑”导致信念下降30点，持续6回合";
...
public class EventGroup12 : EventGroup
{
    ...
    protected override void EffectA(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
        //zz（xx所在事业部）获得状态“迷路”×1，每个“迷路”导致信念下降30点，持续6回合
    }
    protected override void EffectB(Employee emp, int ExtraCorrection = 0, Employee target = null)
    {
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "由于部门裁撤，xx和同事们每次路过之前部门所在的区域附近都会迷路";
        else if (index == 2)
            content = "被裁撤的部门带走了xx和同事们一起工作时准备的一些资料";
        else if (index == 3)
            content = "xx和同事们非常担心今天是删除部门，明天就是删除他们";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "zz（xx所在事业部）获得状态“迷路”×1，每个“迷路”导致信念下降30点，持续6回合";
        else if (index == 2)
            content = "公司获得状态“资料丢失”×1，每个“资料丢失”状态降低士气10点，持续6回合";
        else if (index == 3)
            content = "zz（xx所在事业部）所有员工主导情绪变为“沮丧”";
...
public class EventGroup13 : EventGroup
{
    ...
    public override string EventDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "xx和事业部的同事非常怀念当时跟被裁撤的部门一起工作的日子";
        else if (index == 2)
            content = "由于删除了建筑物，xx所在的事业部需要处理本不属于本部门的额外工作";
    ...
    public override string ResultDescription(Employee Emp, Employee targetEmp, int index, EventGroupInfo egi = null)
    {
        ...
        if (index == 1)
            content = "zz（xx所在事业部）全体员工主导情绪变为“沮丧”";
        else if (index == 2)
